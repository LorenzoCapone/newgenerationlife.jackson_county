...
_acecheck = ["ACE_atropine","ACE_morphine","ACE_epinephrine","ACE_CableTie","ACE_EarPlugs","ACE_fieldDressing","ACE_elasticBandage","ACE_quikclot","ACE_quikclot","ACE_bloodIV_500","ACE_bloodIV_250","ACE_bodyBag","ACE_packingBandage","ACE_personalAidKit","ACE_plasmaIV","ACE_plasmaIV_500","ACE_plasmaIV_250","ACE_salineIV","ACE_salineIV_500","ACE_salineIV_250","ACE_surgicalKit","ACE_tourniquet"];
