...
/* System Settings */
    ...
    gang_price = 1000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    fuelTank_winMultiplier = 1000; //Win Multiplier in FuelTank Missions. Increase for greater payout. Default = 1
